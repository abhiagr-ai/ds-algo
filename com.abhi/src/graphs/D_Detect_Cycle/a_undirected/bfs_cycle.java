...
public class bfs_cycle {
    ...
    static boolean bfs(Map<Integer, List<Integer>> adj, boolean[] visited, int u, int parent) {
        Queue<Pair> q = new ArrayDeque<>();
        q.offer(new Pair(u, parent));
        visited[u] = true;
        while (!q.isEmpty()){
